...
{site_name} 에 대한 사이트 요약입니다:

👉[{title}]
이모지 핵심 내용 1 (2~3문장으로 충분히 설명)
이모지 핵심 내용 2 (2~3문장으로 충분히 설명)
이모지 핵심 내용 3 (2~3문장으로 충분히 설명)

[규칙]
- 핵심 내용은 3~5개, 각 항목은 2~3문장으로 구체적으로 써줘.
- 페이지 내용 기반으로 중요한 정보를 빠짐없이 담아줘.
